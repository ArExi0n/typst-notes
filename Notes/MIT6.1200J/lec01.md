...
status: evergreen
related:
  - "[[Notes/MIT6.1200J/typst_notes/lec01.typ|lec01]]"
  - "[[lec01_notes.typ]]"
---
...
#grid(
  ...
  align(right)[Massachusetts Institute of Technology, Spring 2024 \ Z. Abel, B. Chapman, E. Demaine \ revised Saturday 10th February, 2024]
)

#line(length: 100%, stroke: 0.5pt)
#v(0.3em)

#align(center, text(weight: "bold")[Lecture 01: Predicates, Sets, and Proofs])
#v(1em)
...
Also useful to be able to combine sets into other sets, e.g., intersection $A ∩ B = {2}$, union $A ∪ B = {0, 1, 2, 6, {3, 4}, emptyset}$, difference $A - B = A without B = {0, 1, 6}$ (the set of elements in $A$ that are not elements of $B$).
